...
<div class="panel-display panel-3col-resp clearfix" <?php if (!empty($css_id)) { print "id=\"$css_id\""; } ?>>
  ...
  <div class="panel-panel panel-col-sidebar-second">
    <div class="inside"><?php print $content['sidebarsecond']; ?></div>
  </div>
</div>
